    ...
    <div class="body-content">
        <form id="form-add" method="post" class="form-x"
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="${init.agenCode }" name="agenCode" data-validate="required:请输入标题" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="${init.agenName }" name="agenName" data-validate="required:请输入标题" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        var setting = {
            ...
            async:{    //异步加载数据
                ...
                otherParam: ["treeId", "0", "agenCode", "${init.agenCode}"]
            },
            callback: {
