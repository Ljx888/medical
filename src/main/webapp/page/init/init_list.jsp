    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li> <a class="button border-main icon-plus-square-o" href="page/init/input"> 添加内容</a> </li>
                <li>搜索：</li>
                <li>
                ...
                <tr>
                    ...
                    <td>
                        <div class="button-group">
                            <a class="button border-main" href="page/init/get?agenCode=${list.agenCode}"><span class="icon-edit"></span> 修改</a>
                            <a class="button border-red" href="page/init/del?agenCode=${list.agenCode}"><span class="icon-trash-o"></span> 删除</a>
                        </div>
                    </td>
                </tr>
            </c:forEach>
