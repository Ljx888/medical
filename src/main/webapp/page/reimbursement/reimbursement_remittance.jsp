...
<body>
<form method="get" action="page/reimbursement/listRemittance" id="listform">
                ...
                <tr>
                    ...
                    <td>
                        <div class="button-group">
                            <c:if test="${list.isRemittance == 1}">
                                <a class="button border-main" href="page/reimbursement/editRemittance?reimbursementNumber=${list.reimbursementNumber}&isRemittance=2"><span class="icon-edit"></span> 取消</a>
                            </c:if>
                            <c:if test="${list.isRemittance == 2}">
                                <a class="button border-main" href="page/reimbursement/editRemittance?reimbursementNumber=${list.reimbursementNumber}&isRemittance=1"><span class="icon-edit"></span> 确认汇款</a>
                            </c:if>
                        </div>
                    </td>
                </tr>
