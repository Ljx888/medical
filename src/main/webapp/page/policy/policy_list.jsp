...
<body>
<form method="get" action="page/policy/list" id="listform">
    <div class="panel admin-panel">
        <div class="panel-head"><strong class="icon-reorder"> 内容列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li> <a class="button border-main icon-plus-square-o" href="page/policy/policy_add.jsp"> 添加内容</a> </li>
                <li>搜索：</li>
                <li>
                    <input type="text" placeholder="请输入搜索经办名称" name="agenName" class="input" style="width:250px; line-height:17px;display:inline-block" />
                ...
                <tr>
                    ...
                    <td>
                        <div class="button-group">
                            <a class="button border-main" href="page/policy/get?runyear=${list.runyear}"><span class="icon-edit"></span> 修改</a>
                            <a class="button border-red" href="page/policy/del?runyear=${list.runyear}"><span class="icon-trash-o"></span> 删除</a>
                        </div>
                    </td>
                </tr>
            </c:forEach>
