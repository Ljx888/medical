...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form id="form-add" method="post" class="form-x"
              action="page/policy/add">
            <div class="form-group">
                <div class="label">
                    <label>执行年度：</label>
                </div>
                <div class="field">
                    <input type="text" class="input w50" value="" name="runyear"
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="" name="maxline"
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="" name="remark"
