    ...
    <div class="body-content">
        <form id="form-add" method="post" class="form-x"
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <select id="illCode" name="illCode" class="input w50">
                        <option value="${info.illCode}">${info.chronicdis.illName}</option>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" id="birthday" name="startTime" value="${info.startTime}" class="input w50"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" id="birthday2" name="endTime" value="${info.endTime}" class="input w50"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
